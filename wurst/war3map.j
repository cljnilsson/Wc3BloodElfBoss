...
//   Map Author: Chaosy @Hiveworkshop.com
// 
//===========================================================================
...
function CreateBuildingsForPlayer0 takes nothing returns nothing
    ...
    set u = BlzCreateUnitWithSkin( p, 'negm', -2624.0, 2560.0, 270.000, 'negm' )
    set u = BlzCreateUnitWithSkin( p, 'negf', -2432.0, 2624.0, 270.000, 'negf' )
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u = BlzCreateUnitWithSkin( p, 'Hssa', -2397.3, 2180.8, 237.717, 'Hssa' )
    set u = BlzCreateUnitWithSkin( p, 'nemi', -2134.9, 2072.7, 241.845, 'nemi' )
    set u = BlzCreateUnitWithSkin( p, 'hmpr', -2042.4, 2157.6, 262.181, 'hmpr' )
    set u = BlzCreateUnitWithSkin( p, 'nws1', -2142.5, 2441.7, 245.495, 'nws1' )
    set u = BlzCreateUnitWithSkin( p, 'hspt', -1965.7, 1992.2, 225.358, 'hspt' )
    set u = BlzCreateUnitWithSkin( p, 'nhef', -1776.4, 1973.1, 273.594, 'nhef' )
    set u = BlzCreateUnitWithSkin( p, 'nhem', -1709.1, 1994.8, 239.872, 'nhem' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'esen', -2463.6, 1917.1, 296.497, 'esen' )
    set u = BlzCreateUnitWithSkin( p, 'nwat', -2261.1, 1865.4, 274.074, 'nwat' )
